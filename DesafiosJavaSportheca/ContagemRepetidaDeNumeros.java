...
10
 */
package dio.java.desafio.ContagemRepetidaDeNumeros;
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < valores; i++) {
            ...
            if (numeros.containsKey(numero)) {
                int contQtdNumero = numeros.get(numero);
                numeros.put(numero, ++contQtdNumero);
            } else {
        ...
        numeros.entrySet()
                ...
                .forEach(numero -> System.out.println(numero.getKey() + " aparece " + numero.getValue() + " vez(es)"));
    }
}
