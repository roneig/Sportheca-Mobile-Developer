/*
Os meses de junho e julho são tradicionalmente conhecidos no Brasil por suas festas típicas,
...
Cada um deles come de uma a dez porções de mandioca e eles sempre avisam a Marlene com antecedência
a respeito de quantas porções irão comer nesse dia. O tamanho da porção de cada um é diferente,
...
Cansada de ter que calcular quanta mandioca preparar ela te desafiou para escrever um programa que informe
...
O primeiro inteiro representa as porções do Chico,
o segundo do Bento,
o terceiro do Bernardo,
o quarto da Marina e
o quinto a da Iara.
Saída
...
public class QuantaMandioca {
    ...
    public static void main(String[] args) throws IOException {
        ...
        int totalMandioca = 225;         //Marlene por sua vez sempre come 225 gramas de mandioca

        for (int i = 0 ; i < 5; i++) {
            //int numero  = leitor.nextInt();
            totalMandioca += porcoes[i] * leitor.nextInt(); // totaliza  qtd poção x qtd gramas de cada colega
        }
